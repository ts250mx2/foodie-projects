                                ...
                                >
                                    {isUploadingLogo ? (
                                        <div className="flex flex-col items-center">
                                            <svg width="32" height="32" className="animate-spin h-8 w-8 text-primary-500 mb-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                        ...
                                        <div className="text-center p-4">
                                            <svg width="40" height="40" className="w-10 h-10 mx-auto text-gray-400 group-hover:text-primary-500 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
