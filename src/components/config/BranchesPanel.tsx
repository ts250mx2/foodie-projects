...
import { Search, Pencil, Trash2, Phone, Mail, AlertTriangle, Plus } from 'lucide-react';
...
/**
 * Contenido de la pestaña "Sucursales" de Configuración General.
 * Es la antigua página de Sucursales sin su PageShell; la barra de búsqueda y el
 * botón de agregar viven ahora dentro del propio panel.
 */
    ...
    return (
        <>
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden flex flex-col">
                ...
                {/* Footer con conteo */}
                {!isLoading && sortedAndFilteredBranches.length > 0 && (
                    <div className="px-6 py-3 border-t border-gray-100 bg-gray-50/50 flex items-center justify-between">
                        <span className="text-xs text-gray-600 font-medium">
                            {sortedAndFilteredBranches.length} de {branches.length} sucursales
                        </span>
                    </div>
                )}
            </div>
