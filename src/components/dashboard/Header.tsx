        ...
        >
            <div className="flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="h-[58px] w-[58px] rounded-full bg-white border-2 border-white/80 shadow-xl overflow-hidden shrink-0 relative z-10" style={{ marginTop: '-8px', boxShadow: '0 8px 24px rgba(0,0,0,0.25)' }}>
                        <img
