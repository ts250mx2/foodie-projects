...
export async function PUT(
    ...
    try {
        ...
        return NextResponse.json({ success: false, message: 'Error updating presentation' }, { status: 500 });
    } finally {
...
export async function DELETE(
    ...
    try {
        ...
        return NextResponse.json({ success: false, message: 'Error deleting presentation' }, { status: 500 });
    } finally {
        if (connection) await connection.end();
    }
}
