    ...
    try {
        ...
        const [rows] = (await connection.query(
            `SELECT v.Dia as day, t.Turno as shiftName, 
                    ...
                    SUM(v.Venta * ter.Comision / 100) as commission
        ...
        console.error('Error fetching monthly terminal sales:', error);
        return NextResponse.json({ success: false, message: 'Error fetching monthly terminal sales' }, { status: 500 });
    } finally {
