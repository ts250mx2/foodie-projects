  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-primary-50 via-secondary-50 to-primary-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4 text-center mt-16 relative overflow-hidden">
        ...
        {/* Decorative Blobs */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary-300/30 dark:bg-primary-500/10 rounded-full blur-3xl -z-10 animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-secondary-300/30 dark:bg-secondary-500/10 rounded-full blur-3xl -z-10 animate-pulse delay-1000"></div>

        <h1 className="text-5xl md:text-7xl font-extrabold mb-6 bg-gradient-to-r from-primary-500 via-secondary-500 to-secondary-800 bg-clip-text text-transparent drop-shadow-sm">
          {t('title')}
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full px-4">
          <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-lg p-8 rounded-2xl shadow-lg border border-white/20 dark:border-gray-700 hover:transform hover:-translate-y-2 transition-all duration-300">
            <div className="w-12 h-12 bg-primary-100 dark:bg-primary-900/50 rounded-lg flex items-center justify-center mb-4 mx-auto text-primary-600 dark:text-primary-400">
          ...
          <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-lg p-8 rounded-2xl shadow-lg border border-white/20 dark:border-gray-700 hover:transform hover:-translate-y-2 transition-all duration-300">
             <div className="w-12 h-12 bg-secondary-100 dark:bg-secondary-900/50 rounded-lg flex items-center justify-center mb-4 mx-auto text-secondary-600 dark:text-secondary-400">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
