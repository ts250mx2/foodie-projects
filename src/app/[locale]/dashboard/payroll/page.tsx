...
export default function PayrollDashboardPage() {
    ...
    const menuCards = [
        {
            ...
            description: locale === 'es' 
                ? 'Asignación de turnos semanales y programación del personal.' 
                : 'Weekly shifts assignment and staff scheduling.',
            href: `/dashboard/payroll/schedules`,
            icon: CalendarDays,
            badge: locale === 'es' ? 'Horarios' : 'Schedules'
        },
        {
            key: 'payrollCapture',
            title: t('payrollCapture'),
            description: locale === 'es' 
                ? 'Cálculo y dispersión de nóminas, bonos, faltas y retenciones.' 
                : 'Calculation and disbursement of payrolls, bonuses, absences and retentions.',
            href: `/dashboard/payroll/capture`,
            icon: Banknote,
            badge: locale === 'es' ? 'Nómina' : 'Payroll'
        }
    ];
    ...
    return (
        <PageShell 
            title={t('payroll')} 
            subtitle={locale === 'es' 
                ? 'Control de asistencia, planeador de turnos semanales y cálculo de nóminas operativas.' 
                : 'Attendance control, weekly shift planner and operational payroll calculation.'}
            icon={Users}
        >
